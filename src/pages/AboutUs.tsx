          ...
          <CardContent className="p-8">
            ...
            <div className="prose max-w-none text-gray-600">
              <p className="text-lg mb-4">
                Founded in 2024, Dexotix emerged from a simple observation: finding and booking events should be as exciting as attending them. Our founders, passionate event-goers themselves, noticed the fragmented landscape of event discovery and decided to create a unified platform.
              </p>
              <p className="text-lg mb-4">
