...
const Register = () => {
  ...
  const checkBlockedContacts = async () => {
    try {
      ...
      if (data && data.length > 0 && data[0].is_blocked) {
        ...
        // Send automatic email with user details to help@dexotix.com
  ...
  const sendBlockedContactEmail = async (userData) => {
    try {
      ...
      // This would send an email to help@dexotix.com with the user details
          ...
          <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6 text-center">
              ...
              <div className="flex flex-col space-y-3">
                <Button 
                  onClick={() => window.location.href = 'mailto:help@dexotix.com'}
